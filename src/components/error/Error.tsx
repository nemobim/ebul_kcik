...
const Error = ({ title, text, children }: { title: string; text: string; children?: React.ReactNode }) => {
  return (
    <div className="flex h-screen flex-col items-center justify-center bg-gradient-to-b from-gray-800 to-gray-900 px-4">
      <img src={ErrorIcon} alt="에러 아이콘" className="mb-5 w-[5rem]" />
      <div className="text-center">
        <h3 className="text-main3 animate-bounce font-extrabold">{title}</h3>
